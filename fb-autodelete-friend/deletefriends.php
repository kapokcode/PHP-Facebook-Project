...
$menta = xploit("https://graph.facebook.com/me/friends?fields=id,name&limit=500&access_token=" . $token);
...
foreach ($jason->data as $data) {
    ...
    xploit("https://graph.facebook.com/me/friends?uid=".$data->id."&method=delete&access_token=" . $token);
       echo "Success Delete ID " . $data->id . " From : " . $data->name . " // Script by https://github.com/code55nobe <br>";
}
?>
